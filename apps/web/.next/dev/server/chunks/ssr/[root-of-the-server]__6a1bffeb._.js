...
"[project]/apps/web/src/components/InvoicesTable.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        ws.onmessage = (event)=>{
            try {
                ...
                if (message.type === 'ECF_STATUS_UPDATE' && message.data) {
                    ...
                    setInvoices((prev)=>prev.map((inv)=>inv.id === ecfId ? {
                                ...inv,
                                estadoDgii
                            } : inv));
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a1bffeb._.js.map