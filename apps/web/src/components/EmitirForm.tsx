            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div className="card" style={{ padding: '1.5rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem' }}>
                        ...
                        <button type="button" onClick={addItem} className="btn-ghost" style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                        ...
                        {items.map((item, index) => (
                            <div key={index} style={{
                                ...
                                <button
                                    ...
                                    onMouseEnter={e => { if (items.length > 1) { (e.currentTarget as HTMLButtonElement).style.background = 'var(--color-danger-soft)'; (e.currentTarget as HTMLButtonElement).style.color = 'var(--color-danger)'; } }}
