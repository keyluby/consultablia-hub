...
const navItems = [
    ...
    },
    {
        ...
        icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 7V4h3m10 0h3v3M4 17v3h3m10 0h3v-3" /><rect x="8" y="8" width="8" height="8" rx="2" /><line x1="12" y1="12" x2="12" y2="12" />
            </svg>
        ),
    },
];
        ...
        <aside style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem', alignItems: 'center' }}>
                {bottomItems.map((item) => (
                    <button key={item.label} title={item.label} className="sidebar-nav-item" style={{ border: 'none', background: 'none' }}>
                        {item.icon}
                    </button>
                ))}
